...
export default function FaqCard({
  ...
  return (
    <section className="text-slate-400 bg-slate-950/50 rounded p-2 flex flex-col justify-center w-full  border border-purple-300/20">
      <div className="flex items-center justify-between gap-0.5">
        ...
        <button onClick={handleClick} class="cursor-pointer">
          <svg
            ...
            className={`transform transition-all duration-300 ease-in-out  fill-purple-300 hover:fill-purple-400 ${
	...
	l13.138-13.137C85.484,70.789,85.484,69.53,84.707,68.752z"
      ...
      <div className={`${isAnswerVisible ? "" : "hidden"}`}>
