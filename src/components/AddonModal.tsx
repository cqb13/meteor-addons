...
export default function AddonModal({
  ...
  return (
    ...
    >
      <div
        className="z-20 bg-slate-900 border border-purple-300/20 rounded w-3/4 h-11/12 overflow-scroll flex flex-col justify-between items-center p-5 text-slate-400"
      ...
      >
        ...
        <section class="flex items-center justify-center gap-2 w-1/2">
